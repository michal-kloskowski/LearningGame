...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateMonsters()
        {
            ...
            Monster giantSpider = new Monster(MONSTER_ID_GIANT_SPIDER, "Giant spider", 20, 5, 40, 10);
        ...
        private static void PopulateLocations()
        {
            ...
            alchemistHut.AvailableQuest = QuestByID(QUEST_ID_CLEAR_ALCHEMIST_GARDEN);

            Location alchemistsGarden = new Location(LOCATION_ID_ALCHEMISTS_GARDEN, "Alchemist's garden", "Many plants are growing here.");
            alchemistsGarden.LivingMonster = MonsterByID(MONSTER_ID_RAT);

            Location farmhouse = new Location(LOCATION_ID_FARMHOUSE, "Farmhouse", "There is a small farmhouse, with a farmer in front.");
            farmhouse.AvailableQuest= QuestByID(QUEST_ID_CLEAR_FARMERS_FIELD);

            Location farmersField = new Location(LOCATION_ID_FARM_FIELD, "Farmer's field", "You see rows of vegetables growing here.");
            farmersField.LivingMonster= MonsterByID(MONSTER_ID_SNAKE);
            ...
            spiderField.LivingMonster = MonsterByID(MONSTER_ID_GIANT_SPIDER);
